...
class CashFlowStatement:
    ...
    def calculate_capital_expenditure(self, previous_year_investments_in_property_plant_and_equipment: int):
    ...
    def calculate_free_cash_flow(self, interest_expense: int, tax_shield: int):
        ...
        and assets as well as changes in working capital from the balance sheet. Interest expense and tax shield come from the income statement."""
