...
class FinancingActivities:
    ...
    net_cash_used_provided_by_financing_activities: int = field(init=False)

    def __post_init__(self):
        self.net_cash_used_provided_by_financing_activities = (
            sum_all_initialized_int_attributes(self)
        )
