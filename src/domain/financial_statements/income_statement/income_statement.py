...
class IncomeStatement:
    ...
    def calculate_earnings_per_share(self, initial_shares_outstanding: int):
        ...
        avg_shares_outstanding = (
            initial_shares_outstanding + self.shares_outstanding
        ) / 2
        self.earnings_per_share = self.net_income / avg_shares_outstanding

    def calculate_earnings_per_share_diluted(
        self, initial_shares_outstanding: int, additional_dilution: int
    ):
        ...
        self.earnings_per_share_diluted = self.net_income / (
            avg_shares_outstanding + additional_dilution
        )
