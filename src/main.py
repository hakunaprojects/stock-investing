...
def print_api_financial_modeling_prep_responses():
    ...
    print(api_financial_modeling_prep.get_stock_fundamentals(symbol='AAPL',
                                                             fundamental=FinancialStatementsEnum.BALANCE_SHEET_STATEMENT))
    print(api_financial_modeling_prep.get_stock_fundamentals(symbol='AAPL',
                                                             fundamental=FinancialStatementsEnum.CASH_FLOW_STATEMENT))
    print(api_financial_modeling_prep.get_stock_fundamentals(symbol='AAPL',
                                                             fundamental=FundamentalsAnalysisEnum.COMPANY_KEY_METRICS_SCHEMA))
    print(api_financial_modeling_prep.get_stock_fundamentals(symbol='AAPL',
                                                             fundamental=FundamentalsAnalysisEnum.COMPANY_FINANCIAL_GROWTH))
    print(api_financial_modeling_prep.get_stock_fundamentals(symbol='AAPL',
                                                             fundamental=FundamentalsAnalysisEnum.COMPANY_FINANCIAL_RATIOS))
    print(api_financial_modeling_prep.get_stock_fundamentals(symbol='AAPL',
                                                             fundamental=FundamentalsAnalysisEnum.INCOME_STATEMENT_GROWTH))
