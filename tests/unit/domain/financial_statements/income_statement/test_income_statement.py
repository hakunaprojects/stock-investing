from src.domain.financial_statements.income_statement.income_statement import IncomeStatement
from src.domain.financial_statements.income_statement.non_operating_section import NonOperatingSection
from src.domain.financial_statements.income_statement.operating_section import OperatingRevenueSection, \
    OperatingExpensesSection, OperatingSection
...
class TestIncomeStatement:
    ...
    def test_given_all_components_when_build_income_statement_object_then_it_should_be_built_as_expected(self):
        ...
        # Asserts
        assert income_statement.operating_section.operating_revenue_section.gross_profit == expected_gross_profit
        assert income_statement.operating_section.operating_expenses_section.total_operating_expenses == expected_total_operating_expenses
    ...
    def test_given_variables_when_call_earnings_per_share_then_it_should_be_calculated(self):
        income_statement = IncomeStatement(
            operating_section=build_operating_section(),
            non_operating_section=build_non_operating_section(),
            income_before_tax=109207000000,
        ...
        income_statement.calculate_earnings_per_share(
            initial_shares_outstanding=1000
        )
        expected_net_income = 94680000000
    ...
    def test_given_variables_when_call_earnings_per_share_diluted_then_it_should_be_calculated(self):
        income_statement = IncomeStatement(
            operating_section=build_operating_section(),
            non_operating_section=build_non_operating_section(),
            income_before_tax=109207000000,
        ...
        # Asserts
        assert income_statement.net_income == expected_net_income
        assert income_statement.earnings_per_share_diluted == expected_earnings_per_share_diluted
